...
namespace HF2LI_namespace
{
    public class HF2LI
    {
        ...
        //public string data_controller = "HF2LI";
        ...
        public bool testconnection()
        {
            if (!connected)
            {
                try
                {
                    ...
                    Thread.Sleep(1000);
                    //devstr = Properties.Settings.Default.HF2LI_dev;
                    ...
                    {
                        connected = true;
                        Console.WriteLine("Connection to HF2LI " + devstr + " was successful");
                        return true;
                    }
                    else
                    {
                        Console.WriteLine("Connection to HF2LI failed, reconnecting..." + devstr);
                ...
                {
                    connected = false;
                    Console.WriteLine("Problem connecting to HF2LI " + ee);
                    return false;
                }
            }
            else
        ...
        public bool close_conn()
        {
            if (connected)
            {
                ...
                {
                    Console.WriteLine("Problem closing connection to HF2LI " + ee);
                    return false;
                }
            }
            else
        ...
        public bool sendcommand(string send)
        {
            //while (!connected)
            //{
            //    if (Properties.Settings.Default.data_controller == "HF2LI")
        ...
        public string readBack()
        {
            ...
            {
                //Console.WriteLine("Problem reading data back from HF2LI " + ee);
                return returnstring;
            }
            catch (Exception ee)
            {
        ...
        */
        ...
        //    catch
        //    {
        //        Console.WriteLine("Problem reading data from HF2LI");
        //        return 0;
        //    }
        //}
    }
